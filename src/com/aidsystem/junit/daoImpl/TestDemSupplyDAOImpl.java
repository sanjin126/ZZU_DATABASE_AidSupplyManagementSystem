...
public class TestDemSupplyDAOImpl {
	...
	public void testInsertDemand() throws Exception {
		...
		DemandSupply demand = new DemandSupply(0, "test", null, new Timestamp(new Date().getTime()), 1001, null, false, false);
	...
	public void testDeleteDemandById() throws Exception {
		Connection conn = JDBCUtils.getConnection();
		dao.deleteDemandById(conn, 10016);
	}

	@Test
	public void testUpdateDemand() throws Exception {
		Connection conn = JDBCUtils.getConnection();
		DemandSupply demand = new DemandSupply(10017, "test", null, new Timestamp(new Date().getTime()), 1002, null, false, false);
	...
	public void testGetDemandById() throws Exception {
		Connection conn = JDBCUtils.getConnection();
		System.out.println(dao.getDemandById(conn, 10002));
	}
